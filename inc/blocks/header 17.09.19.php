...
?>
					...
					<p class="social">
						<a href="#" class="sots_fb" title="Окна-А в Facebook" target="_blank"><img src="img/sots_sety_ico.png"></a><a href="#" class="sots_inst" title="Окна-А в Instagram" target="_blank"><img src="img/sots_sety_ico.png"></a>
					</p>
				</div>
